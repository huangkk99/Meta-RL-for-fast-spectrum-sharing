...
meta_label = 'sarl_model_meta_ppo_test'  # the label of the folder of meta parameters
n_veh = 4
n_neighbor = 1
n_RB = n_veh
...
agent = Agent()
# If you don't load the meta parameters, you can change the n_episode to a larger value, such as 3000~6000, to learn from scratch.
model_path = meta_label + '/agent'
